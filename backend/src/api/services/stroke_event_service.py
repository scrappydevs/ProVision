...
def _classify_single_event_with_claude(
    ...
    prompt = (
        ...
        "- Evaluate ONLY the selected primary athlete (the user-selected player tracked as person_id=0).\n"
        "- If the contact appears to be by the opponent or by an untracked player, classify as no_hit.\n\n"
        ...
        "2. Use 'no_hit' if the selected primary athlete is not the one contacting the ball.\n"
        "3. If it is a shot, you MUST choose exactly one: forehand or backhand. Never return unknown/uncertain.\n"
        "4. If visual evidence is weak or ambiguous, you may keep the backend prior prediction.\n"
        "5. Keep response strictly JSON only.\n\n"

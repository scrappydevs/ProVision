...
import { Users, Gamepad2, Trophy, Settings, PanelLeftClose, PanelLeftOpen, Sun, Moon, Swords, Video } from "lucide-react";
...
const navigation = [
  ...
  { name: "YouTube Clips", href: "/dashboard/youtube-clips", icon: Video },
